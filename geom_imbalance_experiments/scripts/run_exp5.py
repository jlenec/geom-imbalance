#!/usr/bin/env python
"""Run Experiment 5: Concept drift control."""
...
from src.geomimb.experiments.exp5_concept_drift_control import run_experiment
from src.geomimb.utils.logging import setup_logging

def main():
    parser = argparse.ArgumentParser(description='Run Experiment 5: Concept drift control')
    ...
    print(f"Results saved to: {args.outdir}/tables/exp5_results.csv")
