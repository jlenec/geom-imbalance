#!/usr/bin/env python
"""Run Experiment 2: AUC invariance demonstration."""
...
from src.geomimb.experiments.exp2_auc_invariance import run_experiment
from src.geomimb.utils.logging import setup_logging

def main():
    parser = argparse.ArgumentParser(description='Run Experiment 2: AUC invariance')
    ...
    print(f"Results saved to: {args.outdir}/tables/exp2_results.csv")
